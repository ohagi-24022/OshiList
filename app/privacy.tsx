...
const policySections = [
  {
    title: '取得する情報',
    body: 'OshiListでは、ユーザーが登録したグッズ名、シリーズ名、キャラクター名、所持数、ステータス、画像、テーマ設定、推しプロフィール、マイストア情報を扱います。バーコード登録ではJANコード、領収書や写真登録αでは選択または撮影した画像を扱います。商品画像として共有する場合は、共有対象として選択した画像も扱います。',
  },
  {
    title: '利用目的',
  ...
  {
    title: '共有学習データ',
    body: '商品候補、商品画像、ランダムグッズのラインナップ精度を高めるため、JANコード、商品名、キャラクター名、バリエーション名、共有画像の保存先、候補の選択・却下・通報の情報をサーバーへ保存することがあります。これらは他のユーザーにも候補として反映される場合があります。',
  },
  {
    title: '匿名端末ID',
